...
test_that("rl_research basic functionality works", {
  with_mock_dir("rl_research-basic", {
...
test_that("rl_research handles parameters correctly", {
  with_mock_dir("rl_research-params", {
...
test_that("rl_research handles edge cases", {
  with_mock_dir("rl_research-edge", {
    # Test invalid inputs
    expect_error(rl_research(code = TRUE))
    expect_error(rl_research(code = "invalid"))
    expect_error(rl_research(code = 999))
  })
})
