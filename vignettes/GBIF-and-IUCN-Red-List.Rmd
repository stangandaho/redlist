...
# Define required packages
packages <- c("rgbif", "redlist", "dplyr", "ggplot2")
...
```{r temporal-viz, fig.width=7, fig.height=4, fig.alt='Temporal distribution', eval=TRUE}
species_of_interest %>%
  count(year) %>%
